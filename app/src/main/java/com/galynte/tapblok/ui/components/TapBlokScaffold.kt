...
/**
 * Shared Scaffold wrapper used by secondary screens (App Selection, QR Code, Settings).
 * Provides a consistent TopAppBar with back navigation and optional actions.
 */
